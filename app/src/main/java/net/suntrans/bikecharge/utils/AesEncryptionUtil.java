...
public class AesEncryptionUtil {
    ...
    public static IvParameterSpec createIV(String password) {
        byte[] data = null;
        if (password == null) {
            password = "";
        }
...
//        String result = byte2hex(data);
     ...
     * 解密字节数组
     **/
    public static byte[] decrypt(byte[] content, String password, String iv) throws Exception {
        SecretKeySpec key = createKey(password);
        Cipher cipher = Cipher.getInstance(CipherMode);
     ...
     * 解密(输出结果为字符串)
     **/
    public static String decrypt(String content, String password, String iv) throws Exception {
        byte[] data = null;
