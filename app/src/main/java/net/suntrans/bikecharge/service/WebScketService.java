package net.suntrans.bikecharge.service;
...
import net.suntrans.bikecharge.websocket.WebSocketWrapper;
...
public class WebScketService extends Service implements WebSocketWrapper.onReceiveListener {
    ...
    public void onMessage(String s) {
        ...
        try {
            ...
            Message message1 = new Message(status_code, message);
            RxBus.getInstance().post(message1);
